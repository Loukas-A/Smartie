...
print(
    "Loading Smartie version 0.0.1 Alpha. I am currently not sorking at full capacity due to errors, but don't worry, a patch is being worked on and we will soon be finished and back to normal."
)
print('                                           ')
print('                                           ')
print('                                           ')
